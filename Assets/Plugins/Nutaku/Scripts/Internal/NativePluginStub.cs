...
namespace Nutaku.Unity
{
    ...
    class NativePluginStub : INativePlugin
    {
        ...
        const string SandboxAppId = "79393";
        const string SandboxConsumerKey = "H8YhSB9Xda5Q96UY";
        const string SandboxConsumerSecret = "yRnlf9_hHFr1ExN]wzgb5g68g1MgXu-c";
        ...
        internal static void Initialize()
        {
            ...
            Debug.Log("SDK Nutaku in Editor Integrated!");
        }
        ...
        public void crossDeeplinkToGame(string game_id)
        {
            Debug.LogError("crossDeeplinkToGame is not available in Unity Editor. You need to be running on a device.");
        }
